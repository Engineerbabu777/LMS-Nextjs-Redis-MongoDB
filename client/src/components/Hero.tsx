...
/*  
 ...
 <img src="https://edmy-react.hibootstrap.com/images/banner/client-3.jpg" alt="text-1" className="rounded-full /> 
 <img src="https://edmy-react.hibootstrap.com/images/banner/client-1.jpg" alt="text-2" className="rounded-full ml-[-20px]" /> 
 <img src="https://edmy-react.hibootstrap.com/images/banner/client-2.jpg" alt="text-3" className="rounded-full ml-[-20px]" /> 
*/
